...
Others: number of positive hauls, status quo OFL, species type

still need to try on Monday- assessment model type? species?
used a mixed effects model to look at difference in sigma between species vs between species type, vs between reduction type
